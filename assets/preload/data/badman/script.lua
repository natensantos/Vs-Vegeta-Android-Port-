...
local del2 = 0;
function noteMiss()
	if getProperty('SONG.player2') == 'vegeta-supasaiyajin' then
...
function onUpdate()
	noteTweenAlpha('null', 1, 0, 0.00000000000000000000000000000000000000000000001);
	noteTweenX('defaultOpponentStrumX0', 0, 200, 0.3);
    if getProperty('SONG.player2') == 'vegeta' then
        xofs = 10;
        yofs = 10;
    end
	if getProperty('SONG.player2') == 'vegeta-supasaiyajin' then
